...
export default {
  ...
  methods: {
    ...
    async loadTotalQuestions() {
      try {
        const res = await axios.get('http://123.207.43.214:8080/api/questions/count')
    ...
    async loadQuestionIds() {
      try {
        const res = await axios.get('http://123.207.43.214:8080/api/questions/ids')
    ...
    async loadQuestion(id) {
      ...
      try {
        ...
        const res = await axios.get(`http://123.207.43.214:8080/api/questions/${validId}`)
